								...
								items : [
										{
											...
											items : [ {
												...
												layout : {
													...
													columns : 2,
													tdAttrs : {
														style : 'margin:0 auto,text-alig:center'
													}
												},
//												defaults : {
												...
												items : [
														{
															...
															icon : null,
															cls : 'thumbnail-icon-wrap2 icon-border-hexagon',
														...
														},
														{
															...
															bodyPadding : 20,
															html : '<a href="#"  onclick="onAddTabClick()" style="text-decoration:none"><div class="thumbnail-icon-wrap icon-border-circle"><div class="thumbnail-icon icon-grouped-header-grid"></div><h3>novo</h3></div></a>'
														// xtype: 'dataview',
														// tpl: [
														// '<tpl for=".">',
														// '<div
														// class="dataview-multisort-item">',
														// '<img
														// src="resources/images/touch-icons/{thumb}"
														// />',
														// '<h3>{name}</h3>',
														// '</div>',
														// '</tpl>'
